...
public class IndicatorControlUnit extends Subscriber {
    ...
    public void receive(EventLeftIndicatorOn event) {
        for (Object indicator : indicators) {
            IndicatorState result = (IndicatorState) ComponentUtils.invokeMethod(indicator, "on", new Class[]{IndicatorState.class}, event.getState());
    ...
    public void receive(EventLeftIndicatorOff event) {
        for (Object indicator : indicators) {
            IndicatorState result = (IndicatorState) ComponentUtils.invokeMethod(indicator, "off", new Class[]{IndicatorState.class}, event.getState());
            System.out.println("receive -> indicator | state : " + result);
        }
    }
